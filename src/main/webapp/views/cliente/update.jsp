...
<body>
	...
	<main class="container_formulario">
		<div class="ajustes-cor-formulario">
			...
			<h4>Preencha o formulário abaixo para atulizar seus dados</h4>
			<form action="./cliente-update">
				<fieldset class="caixa_formulario">
					<div class="campo">
						<legend> CPF </legend>
						<input type="number" placeholder="Digite o seu CPF" id="cpf"
							name="cpf" class="form-control" value="${cliente.cpf}">
					</div>
					<div class="campo">
						<legend> Idade </legend>
						<input type="number" placeholder="Informe a sua idade" id="idade"
							name="idade" class="form-control" value="${cliente.idade}">
					</div>
					<div class="campo">
						<legend> Quantos acompanhantes? </legend>
						<input type="number"
							placeholder="Quantos acompanhantes irão com você?"
							id="acompanhantes" name="acompanhantes" class="form-control"
							value="${cliente.acompanhantes}">
					</div>
					<div class="campo">
						<div class="campo">
							<legend> Nome </legend>
							<input type="text" placeholder="Qual é o seu nome?" id="nome"
					...
					<div class="campo">
						<legend> Senha </legend>
						<input type="text" placeholder="Digite a sua senha: " id="senha"
							name="senha" class="form-control" value="${cliente.senha}">
					</div>
