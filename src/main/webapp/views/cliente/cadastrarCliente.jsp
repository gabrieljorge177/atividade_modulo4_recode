...
<!--Início do main - conteúdo principal (formulário) para cadastro do clientee-->
      ...
      <div class="ajustes-cor-formulario">
         ...
         <form action="../../cliente-create">
            <fieldset class="caixa_formulario">
               <div class="campo">
                  <legend> CPF </legend>
                  <input type="number" placeholder="Digite o seu CPF" id="cpf" name="cpf" class = "form-control" >
               </div>
               <div class="campo">
                  <legend> Idade </legend>
                  <input type="number" placeholder="Informe a sua idade" id="idade" name="idade" class = "form-control" >
               </div>
               <div class="campo">
                <legend> Quantos acompanhantes? </legend>
                <input type="number" placeholder="Quantos acompanhantes irão com você?" id="acompanhantes" name="acompanhantes" class = "form-control" >
             </div>
               <div class="campo">
                <div class="campo">
                    <legend> Nome </legend>
                    <input type="text" placeholder="Qual é o seu nome?" id="nome" name="nome" class = "form-control" >
                </div>
                  <legend> Email: </legend>
                  <input type="email" placeholder="Digite o seu email" id="email" name="email" class = "form-control" >
               </div>
               <div class="campo">
                  <legend> Senha </legend>
                  <input type="text" placeholder="Digite a sua senha: " id="senha" name="senha" class = "form-control" >
               </div>
...
<!--Final do main - conteúdo principal (formulário) para cadastro do clientee-->
