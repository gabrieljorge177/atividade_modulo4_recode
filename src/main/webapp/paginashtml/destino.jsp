...
<!--Início da section que busca através de cards mostrar os destinos mais visitados do último mês-->
     <section class="cards-sugestaodest">
        ...
        <div class="card-group">
           <div class="card">
              <img class="card-img-top img-fluid" src="../assets/images/barcelona_card.jpg" alt="Imagem de capa do card">  
              <div class="card-body">
           ...
           <div class="card">
              <img class="card-img-top img-fluid" src="../assets/images/chapada_dos_veadeiros_card2.jpg" alt="Imagem de capa do card">
              <div class="card-body">
           ...
           <div class="card">
              <img class="card-img-top img-fluid" src="../assets/images/fernandodenoronha_Card3.jpg" alt="Imagem de capa do card">
              <div class="card-body">
